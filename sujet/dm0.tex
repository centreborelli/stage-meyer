...
\[
	...
	=
	c_\Lambda\sum{q\in\Lambda^*}\widehat\varphi(q)
\]
...
géométrique à~$c_\Lambda$ et~$\Lambda^*$.\\
{\sl Indication: appliquez un changement de variable linéaire à la formule de Poisson classique sur~$\Z^2$.}

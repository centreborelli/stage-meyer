...
La~\emph{coupe} horizontale d'épaisseur~$2a$ de la fonction~$f(x,y)$ est la
...
{\bf Exercice 6. (coupe et projection de distributions)}
...
Calculez la coupe\&projection d'un peigne de Dirac
...
la coupe\&projection de~$\Z^5$ sur le premier sous-espace donne lieu à un pavage
apériodique de~$\R^2$.
